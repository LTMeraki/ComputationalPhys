...
# Description: this program imports an excel file with a table of position and time, performs numerical differentiation to find the velocities and accelerations and exports a new excel file with the generated table.
